...
-- возвращяем полю metadata тип JSON
...
-- Исправляем сообщения from_user_id != to_user_id
...
-- меняем тип поля gender на Integer под внешний ключ genders
-- меняем название поля profiles.gender на gender_id 
